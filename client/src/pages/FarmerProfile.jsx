...
const s = {
  page: { minHeight: '100vh', background: '#f5f7f2', padding: '40px 48px', maxWidth: 1100, margin: '0 auto' },
  banner: { background: 'linear-gradient(135deg,#1a3a10,#2d5a1e)', border: '1px solid rgba(60,100,40,.12)', borderRadius: 20, padding: 36, marginBottom: 36, display: 'flex', gap: 28, alignItems: 'flex-start', flexWrap: 'wrap' },
  ...
  name: { fontSize: 26, fontWeight: 700, color: '#1a2415', marginBottom: 4 },
  farm: { fontSize: 15, color: '#4e9e2a', marginBottom: 8 },
  meta: { fontSize: 13, color: '#7a9070', display: 'flex', gap: 20, flexWrap: 'wrap', marginBottom: 8 },
  ...
  chatBtn: { background: '#4e9e2a', color: '#fff', border: 'none', borderRadius: 99, padding: '10px 24px', fontFamily: 'Plus Jakarta Sans,sans-serif', fontWeight: 600, fontSize: 14, cursor: 'pointer', display: 'inline-block', marginLeft: 'auto', alignSelf: 'center' },
  chatBtnDisabled: { background: 'rgba(60,100,40,.1)', color: '#7a9070', border: 'none', borderRadius: 99, padding: '10px 24px', fontFamily: 'Plus Jakarta Sans,sans-serif', fontWeight: 600, fontSize: 14, cursor: 'not-allowed', display: 'inline-block', marginLeft: 'auto', alignSelf: 'center' },
  sectionTitle: { fontSize: 18, fontWeight: 600, color: '#1a2415', marginBottom: 20 },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(220px,1fr))', gap: 20 },
  productCard: { background: '#fff', border: '1px solid rgba(60,100,40,.12)', borderRadius: 16, overflow: 'hidden', textDecoration: 'none', color: 'inherit', display: 'block' },
  productImg: { width: '100%', height: 160, objectFit: 'cover', background: 'rgba(60,100,40,.1)' },
  productBody: { padding: 16 },
  productName: { fontSize: 14, fontWeight: 600, color: '#1a2415', marginBottom: 4 },
  productPrice: { fontSize: 15, fontWeight: 700, color: '#4e9e2a' },
  empty: { color: 'rgba(255,255,255,.65)', fontSize: 14, padding: '40px 0' },
};
...
export default function FarmerProfile() {
  ...
  if (loading) return <div style={{ ...s.page, color: '#7a9070' }}>Loading...</div>;
  if (!farmer) return <div style={{ ...s.page, color: '#7a9070' }}>Farmer not found.</div>;
