...
export default function Dashboard() {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.kpiRow}>
        <div style={s.kpi}><div style={s.kpiLabel}>Products</div><div style={s.kpiValue}>{stats.products || 0}</div></div>
        <div style={s.kpi}><div style={s.kpiLabel}>Total Orders</div><div style={s.kpiValue}>{stats.orders || 0}</div></div>
        <div style={s.kpi}><div style={s.kpiLabel}>Revenue</div><div style={{ ...s.kpiValue, color: 'var(--green-lt)' }}>BDT {(stats.revenue || 0).toLocaleString()}</div></div>
      </div>
